...
window.hud = {
  update(s) {
    ...
    const TUT_PAGES = [
      { t: "積んだものが<b>溶けて</b><br>また<b>固まる</b>パズル", hi: null },
      { t: "<b>カチカチ</b>の間は通常ルール<br>横1列そろえると消える", hi: null },
      { t: "ゼリーも横1列。崩れる前に消す<br><b>左右で移動</b>　<b>スペースで落下</b>", hi: null },
      { t: "<b>液体</b>は横1列では消えない<br>同じ色を<b>左壁から右壁</b>へつなぐ", hi: null },
      { t: "冷えると再び固まり<br>流れた形が<b>灰色の大地</b>になる", hi: null },
      { t: "大地の上でも横1列で消える<br>真下の大地も崩れる。<b>得点半分</b>", hi: null },
      { t: "続けて消すと<b>連鎖</b><br><b>WAVE</b>を読んで狙う", hi: "wave" },
    ];
    if (s.gstate === "tut") {
